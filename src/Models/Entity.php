...
use Mawuekom\Accontrol\Contracts\Assignables\EntityHasRelations as EntityHasRelationsContract;
...
{
    use SoftDeletes, GeneratesUuid, Slugable, EntityHasRelations;
