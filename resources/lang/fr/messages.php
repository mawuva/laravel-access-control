...
return [
    ...
    'entity'                        => [
        ...
        'saved'                 => ':Entity enregistré(e) avec succès.',
        'list'                  => 'Liste :Entity.',
        'search_results'        => 'Get :Entity search results.',
        'deleted_list'          => 'Liste :Entity supprimé(e)s".',
        'resource'              => 'Ressource :Entity.',
        'updated'               => ':Entity mise à jour avec succès.',
        'changed'               => ':Entity modifié(e) avec succès.',
        'deleted'               => ':Entity supprimé(e) avec succès.',
        'restored'              => ':Entity restauré(e) avec succès.',
        'deleted_permanently'   => ':Entity supprimé(e) définitivement avec succès.',
        'removed'               => ':Entity supprimé(e) définitivement avec succès.',
    ],
];